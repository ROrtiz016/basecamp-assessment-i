...
var responseCreator = function(param){
  // CODE HERE
 if (param === "green"){
  colorResponse === console.log ('Green is okay');
} else if (param === "red"){
  colorResponse === console.log('I heart red');
} else {colorResponse === console.log('Whats your favorite color?')};
